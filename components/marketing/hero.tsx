          ...
          <div className="relative isolate min-h-[19rem] min-w-0 overflow-visible sm:min-h-[38rem] lg:mr-20 lg:min-h-[44rem] xl:mr-32 2xl:mr-44">
            ...
            {activeMobileImage ? (
              <motion.a
                ...
                className="group absolute right-[48%] top-[42%] z-50 hidden w-[18%] min-w-[5.9rem] cursor-pointer text-left outline-none focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-4 focus-visible:ring-offset-[#0d1118] sm:block"
                initial={false}
