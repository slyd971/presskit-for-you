...
export const metadata: Metadata = {
  title: "Contact",
  description: "Contacte PressKit For You pour créer un press kit digital premium sur-mesure.",
};
      ...
      <section className="py-16 md:py-24">
        <PageShell className="max-w-4xl">
          ...
          <h1 className="mt-6 text-5xl font-semibold tracking-tighter2 text-white md:text-7xl">
            Parlons de ton press kit et de l’image que tu veux vraiment envoyer.
          </h1>
          <p className="mt-6 text-lg leading-8 text-white/70">
            Que tu partes de zéro ou d’un univers déjà bien défini, on peut cadrer une base solide,
            premium et pensée pour être partagée rapidement.
          </p>
        </PageShell>
      </section>
      <ContactPanel />
